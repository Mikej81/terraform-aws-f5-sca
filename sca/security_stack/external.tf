    ...
    "0" = {
      "network_interfaces" = {
        ...
        "us-west-1a:public:0" = {
          ...
          "cloudfailover_tag" = "public"
          "private_ips_count" = 0
          "public_ip"         = true
          "subnet_id"         = var.subnets.az1.security.internet
          "subnet_security_group_ids" = [
        ...
        "us-west-1a:private:1" = {
          ...
          "private_ips_count" = 0
          "public_ip"         = false
          "subnet_id"         = var.subnets.az1.security.dmz_outside
          "subnet_security_group_ids" = [
            var.security_groups.private
          ]
        }
    ...
    "0" = {
      "network_interfaces" = {
        ...
        "us-west-1b:public:0" = {
          ...
          "private_ips_count" = 0
          "public_ip"         = true
          "subnet_id"         = var.subnets.az2.security.internet
          "subnet_security_group_ids" = [
            var.security_groups.public
          ]
        }
        ...
        "us-west-1b:private:1" = {
          ...
          "private_ips_count" = 0
          "public_ip"         = false
          "subnet_id"         = var.subnets.az2.security.dmz_outside
          "subnet_security_group_ids" = [
            var.security_groups.private
          ]
        }
...
data "template_file" "external_onboard_az1" {
  ...
  vars = {
    ...
    dmzOutsideGateway  =  var.aws_cidr_ips.az1.security.dmz_outside
    ...
    externalGateway    =  var.aws_cidr_ips.az1.security.internet
    ...
    dmzOutsideNetwork  =  var.subnet_cidrs.az1.security.dmz_outside
    ...
    externalNetwork    =  var.subnet_cidrs.az1.security.internet
...
data "template_file" "external_onboard_az2" {
  ...
  vars = {
    ...
    dmzOutsideGateway  =  var.aws_cidr_ips.az2.security.dmz_outside
    ...
    externalGateway    =  var.aws_cidr_ips.az2.security.internet
    ...
    dmzOutsideNetwork  =  var.subnet_cidrs.az2.security.dmz_outside
    ...
    externalNetwork    =  var.subnet_cidrs.az2.security.internet
