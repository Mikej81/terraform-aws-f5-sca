...
data "template_file" "ips_onboard_az1" {
  ...
  vars = {
    ...
    dmzOutsideGateway  =  var.aws_cidr_ips.az1.security.dmz_inside
    ...
    dmzOutsideNetwork  =  var.subnet_cidrs.az1.security.dmz_inside
    ...
    externalNetwork    =  var.subnet_cidrs.az1.security.dmz_outside
...
data "template_file" "ips_onboard_az2" {
  ...
  vars = {
    ...
    dmzOutsideGateway  =  var.aws_cidr_ips.az2.security.dmz_inside
    ...
    dmzOutsideNetwork  =  var.subnet_cidrs.az2.security.dmz_inside
    ...
    externalNetwork    =  var.subnet_cidrs.az2.security.dmz_outside
